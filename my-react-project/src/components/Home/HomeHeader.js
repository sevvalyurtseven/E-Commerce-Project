  ...
  return (
    <div className="sm:py-10 sm:pl-12 sm:pr-28 py-10 px-12 ">
      <div className="flex flex-col sm:flex-row bg-gradient-to-r from-[#96E9FB] to-[#ABECD6] rounded-3xl pt-4 ">
        ...
        <h2 className="text-center sm:text-start text-slate-800 sm:text-6xl text-2xl font-bold sm:leading-[70px] leading-8 tracking-wider sm:whitespace-nowrap">NEW COLLECTION</h2>
